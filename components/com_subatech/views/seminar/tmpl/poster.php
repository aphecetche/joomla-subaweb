...
<span class="type">
<?php echo JText::_('COM_SUBATECH_SEMINAR').' '; ?>
<?php if ( $this->item->type == "spécialisé" ): ?>
<?php echo JText::_('COM_SUBATECH_SEMINAR_TYPE_SPECIALISE'); ?>
<?php elseif ( $this->item->type == "généraliste" ): ?>
<?php echo JText::_('COM_SUBATECH_SEMINAR_TYPE_GENERALISTE'); ?>
<?php elseif ( $this->item->type == 'ITA'): ?>
<?php echo JText::_('COM_SUBATECH_SEMINAR_TYPE_ITA'); ?>
<?php endif ?>
</span>
