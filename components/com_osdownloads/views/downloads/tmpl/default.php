...
?>
<form action="<?php echo(JRoute::_("index.php?option=com_osdownloads&view=downloads&id=".JRequest::getVar("id")));?>" method="post" name="adminForm">
    <div class="contentopen">
            ...
            <div class="category_children">
				...
				foreach($this->children as $item):?>
                    ...
                    <div class="item<?php echo($i % $NumberOfColumn);?>">
                        <h4><a href="<?php echo(JRoute::_("index.php?option=com_osdownloads&view=downloads&id={$item->id}"));?>"><?php echo($item->title . " (" . $item->total_doc .")");?></a></h4>
        ...
        <?php foreach($this->items as $i => $item):?>
            <h4><a href="<?php echo(JRoute::_("index.php?option=com_osdownloads&view=item&id=".$item->id));?>"><?php echo($item->name);?></a></h4>
            <div class="item_content"><?php echo($item->brief);?></div>
            <div class="readmore_wrapper">
            	<!--<div class="readmore">
                	<a href="<?php echo(JRoute::_("index.php?option=com_osdownloads&view=item&id=".$item->id));?>">
